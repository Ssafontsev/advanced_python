class PersonWithGrades:
    ...
    def rate(self, person, course, grage):
        pass
...
class Student(PersonWithGrades):
    ...
    def __str__(self):
        return 'Имя: {} \nФамилия: {} \nСредняя оценка за домашние задания: {} \nКурсы в процессе изучения: {} \nЗавершенные курсы: {}'.format(
            self.name, self.surname, self.get_avarege_grades(), ', '.join(self.courses_in_progress),
            self.finished_courses)
...
print(some_lecturer)
# print(some_student)
# print(some_student.get_avarege_grades())